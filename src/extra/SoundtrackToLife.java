...
public class SoundtrackToLife {
	...
	public static void main(String[] args) {
		...
		int userMood = JOptionPane.showOptionDialog(null, "hOW dO yOU fEEL?", "Pop-up Title", 0,
				JOptionPane.INFORMATION_MESSAGE, null, new String[] { "Ralph(Mad)", "Dr. Nugget(Internal Screaming)", "Carl(Happy)" }, null);
		
		// 2. Their answer is stored in the userMood variable. Print it out.
System.out.println(userMood);
		// 3. If they are in a stressed mood, use the playVideo method to play a calming song from YouTube.
	if(userMood==0) {
		playVideo("https://www.youtube.com/watch?v=nlYlNF30bVg");
	}
	if(userMood==1) {
		playVideo("https://www.youtube.com/watch?v=nlYlNF30bVg");
	}
