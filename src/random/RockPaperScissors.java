...
public class RockPaperScissors extends JPanel implements ActionListener{
    ...
    public void run(){
		...
		try {
			...
			paperImage = new ImageIcon(getClass().getResource("tp.png"));
			scissorsImage = new ImageIcon(getClass().getResource("skizzors.jpg"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        JOptionPane.showMessageDialog(null, "You chose: " + convertSelection(selection) + ".\n"
                    + "Ralph the almighty chose: " + convertSelection(opponentSelection) + ".\n");
